defmodule Mix.Tasks.Boiler.Gen.Html do
  ...
  Read the documentation for `boiler.gen.schema` for more information on attributes
  ...
  def build(args) do
    if Mix.Project.umbrella? do
      Mix.raise "mix boiler.gen.html and boiler.gen.json can only be run inside an application directory"
    end
  ...
  def copy_new_files(%Context{schema: schema} = context, paths, binding) do
    ...
    Mix.Phoenix.copy_from paths, "priv/templates/boiler.gen.html", "", binding, [
  ...
  def raise_with_help(msg) do
    ...
    mix boiler.gen.html and mix boiler.gen.json expect a context module name,
    followed by singular and plural names of the generated resource, ending
    with any number of attributes. For example:

        mix boiler.gen.html Accounts User users name:string
        mix boiler.gen.json Accounts User users name:string
